...
```
> ./nats-streaming-server
[75895] 2019/04/16 09:56:46.216416 [INF] STREAM: Starting nats-streaming-server[test-cluster] version 0.13.0
...
```
[INF] STREAM: Starting nats-streaming-server[test-cluster] version 0.13.0
