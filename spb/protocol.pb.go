...
type RaftSnapshotFragment struct {
	...
	MessageBatch *Batch                    `protobuf:"bytes,2,opt,name=MessageBatch" json:"MessageBatch,omitempty"`
...
// SubSnapshot is a snapshot of a subscription.
...
func (*SubSnapshot) Descriptor() ([]byte, []int) { return fileDescriptorProtocol, []int{15} }
...
func (m *RaftSnapshotFragment) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MessageBatch != nil {
		...
		n9, err := m.MessageBatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *SubSnapshot) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.AcksPending) > 0 {
		dAtA13 := make([]byte, len(m.AcksPending)*10)
		var j12 int
		...
		dAtA[i] = 0x1a
		i++
		i = encodeVarintProtocol(dAtA, i, uint64(j12))
...
var fileDescriptorProtocol = []byte{
	...
	,
}
