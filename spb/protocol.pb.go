...
type RaftOperation struct {
	...
	AckMsg           *ChannelMessage        `protobuf:"bytes,5,opt,name=AckMsg" json:"AckMsg,omitempty"`
	SendMsg          *ChannelMessage        `protobuf:"bytes,6,opt,name=SendMsg" json:"SendMsg,omitempty"`
...
// ChannelMessage is used to replicate a sent or ack message.
...
func (*ChannelMessage) Descriptor() ([]byte, []int) { return fileDescriptorProtocol, []int{12} }
...
func (*ChannelGossip) Descriptor() ([]byte, []int) { return fileDescriptorProtocol, []int{17} }
...
func init() {
	...
	proto.RegisterType((*ChannelMessage)(nil), "spb.ChannelMessage")
...
var fileDescriptorProtocol = []byte{
	...
	,
}
