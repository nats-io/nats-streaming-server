...
type AddClient struct {
	ConnectRequest *pb.ConnectRequest `protobuf:"bytes,1,opt,name=ConnectRequest" json:"ConnectRequest,omitempty"`
}
...
func (m *AddClient) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConnectRequest != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintProtocol(dAtA, i, uint64(m.ConnectRequest.Size()))
		n9, err := m.ConnectRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *AddClient) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ConnectRequest == nil {
				m.ConnectRequest = &pb.ConnectRequest{}
			}
			if err := m.ConnectRequest.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorProtocol = []byte{
	...
	,
}
