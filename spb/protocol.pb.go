...
const (
	...
	RaftOperation_Connect            RaftOperation_Type = 4
	RaftOperation_Disconnect         RaftOperation_Type = 5
)
...
type RaftOperation struct {
	...
	ClientConnect    *AddClient          `protobuf:"bytes,6,opt,name=ClientConnect" json:"ClientConnect,omitempty"`
	ClientDisconnect *RemoveClient       `protobuf:"bytes,7,opt,name=ClientDisconnect" json:"ClientDisconnect,omitempty"`
}
...
func (*AddClient) Descriptor() ([]byte, []int) { return fileDescriptorProtocol, []int{11} }
...
func (*RemoveClient) Descriptor() ([]byte, []int) { return fileDescriptorProtocol, []int{12} }
...
func (m *RaftOperation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClientConnect != nil {
		...
		n4, err := m.ClientConnect.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
	...
	if m.ClientDisconnect != nil {
		...
		n5, err := m.ClientDisconnect.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *AddClient) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConnectRequest != nil {
		...
		n7, err := m.ConnectRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
var fileDescriptorProtocol = []byte{
	...
	,
}
